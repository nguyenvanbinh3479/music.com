                    ...
                    <div class="au-breadcrumb-content">
                        <div class="au-breadcrumb-left">
                            ...
                            <ul class="list-unstyled list-inline au-breadcrumb__list">
                                ...
                                <li class="list-inline-item"><a href="admin.php?c=comment&a=edit&id=<?php echo $comment->id?>" style="color: #999;">Edit Comment</a></li>
                            </ul>
                        </div>
			...
			<div id="wrapper">
				<div class="container">
					<form method="post" action="admin.php">
						...
						<div class="row">   	
                        <textarea class="form-control" rows="10" cols="10" class="form-control p-2 m-2" name="noi_dung"><?php echo $comment->noi_dung; ?></textarea>
						</div>
						<div class="row">   		
							<label>Ngay:</label>
						</div>
						<div class="row">   	
							<input type="date" class="form-control p-2 m-2" name="ngay" value="<?php echo $comment->ngay; ?>">
						</div>
						<div class="row">   
