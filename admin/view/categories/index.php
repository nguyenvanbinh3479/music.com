              ...
              <div class="table-data__tool">
                ...
                <div class="table-data__tool-right">
                  <button class="au-btn au-btn-icon au-btn--green au-btn--small" type="submit">
                    <a href="admin.php?c=category&a=create" style="color: white;"><i class="zmdi zmdi-plus"></i>add Category</a>
                  </button>
                ...
                <table class="table table-data2">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $category->anh; ?>" style="width: 50px; height: 50px;"></img></td>
                          <td>
                              <div class="table-data-feature">
                                <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                  <a href="admin.php?c=category&a=edit&id=<?php echo $category->id; ?>">
                                    <i class="zmdi zmdi-edit"></i>
                                  </a>
                                </button>
                                <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                  <a href="admin.php?c=category&a=delete&id=<?php echo $category->id; ?>">
