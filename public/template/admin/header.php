...
<head>
    ...
    <link href="public/css/fontawesome-all.min.css" rel="stylesheet" media="all">
    <link href="public/css/material-design-iconic-font.min.css" rel="stylesheet" media="all">

    <!-- Bootstrap CSS-->
    <link href="public/css/bootstrap.min.css" rel="stylesheet" media="all">

    <!-- Vendor CSS-->
    <link href="public/css/animsition.min.css" rel="stylesheet" media="all">
    <link href="public/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet" media="all">
    <link href="public/css/animate.css" rel="stylesheet" media="all">
    <link href="public/css/hamburgers.min.css" rel="stylesheet" media="all">
    <link href="public/css/slick.css" rel="stylesheet" media="all">
    <link href="public/css/select2.min.css" rel="stylesheet" media="all">
    <link href="public/css/perfect-scrollbar.css" rel="stylesheet" media="all">
    ...
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar2">
            <div class="logo">
                <a href="admin.php?c=home">
                    <img src="public/img/logo-white.png" alt="Admin" />
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="public/img/admin.jpg" alt="Kevin Anthony" />
                    </div>
                    <h4 class="name">Kevin Anthony</h4>
                    <a href="admin.php?c=login">Sign out</a>
                </div>
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="admin.php?c=home">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="admin.php?c=setting">
        ...
        <div class="page-container2">
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap2">
                            <div class="logo d-block d-lg-none">
                                <a href="#">
                                    <img src="public/img/logo-white.png" alt="CoolAdmin" />
                                </a>
                            </div>
            ...
            <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
                <div class="logo">
                    <a href="#">
                        <img src="public/img/logo-white.png" alt="Cool Admin" />
                    </a>
                </div>
                <div class="menu-sidebar2__content js-scrollbar2">
                    <div class="account2">
                        <div class="image img-cir img-120">
                            <img src="public/img/avatar-big-01.jpg" alt="Binh Nguyen" />
                        </div>
                        <h4 class="name">Binh Nguyen</h4>
                        <a href="#">Sign out</a>
                    </div>
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
